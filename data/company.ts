export const companyInfo = {
  ...
  description: "Supplier besi dan baja terpercaya di Indonesia",
  founded: 2015,
  vision: "Menjadi mitra terpercaya dalam pembangunan Indonesia",
  mission: [
    "Menyediakan material berkualitas dengan harga kompetitif",
